...
![red-black-tree-wiki-pic](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-example.png)
...
![2-3-tree](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-example.png)
...
![2-node](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-2-node-example.png)

2-节点和普通的二叉查找树的节点没有什么不同。其左儿子表示比`a`小的子树，右儿子表示比`a`大的子树。

接下来是不一样的“3-节点”：

![3-node](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-3-node-example.png)
...
![4-node](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-4-node-example.png)
...
![2-3-tree-5-cases](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-insert-5-cases.png)
...
![4-node-to-2-node](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-4-node-to-2-node.png)
...
![2-3-tree-insert](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-insert-example.png)
...
![2-3-tree-delete-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-1-2.png)
...
![2-3-tree-delete-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-2.png)

但是，上面的做法都是在假设当前正处在一个3-节点处而做的。倘若根节点就不是3-节点，那该怎么办呢？

考虑到根节点的特殊性，我们可以直接将其和它的儿子合并为4-节点。

![2-3-tree-root-transformation](https://riteme.site/blogimg/rbtree-and-2-3-tree/2-3-tree-root-trans-1.png)
...
![2-3-tree-delete-example-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-example-1.png)

从根节点开始，发现`i`在右子树中，但发现根节点自己和左右儿子都是2-节点，于是它们合并为一个4-节点：

![2-3-tree-delete-example-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-example-2.png)

接下来在新的4-节点`d-h-n`中发现右儿子为3-节点，于是直接向下搜索。

在3-节点`j-l`中我们发现`i`在其左子树中，并且左儿子不是3-节点，于是我们将`j`向下合并：

![2-3-tree-delete-example-3](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-example-3.png)

向下后来到4-节点`i-j-k`，发现目标`i`就在其中，我们直接将其删除：

![2-3-tree-delete-example-4](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-example-4.png)

删除完成，我们沿着递归向下的顺序向上回溯。回溯到根节点时，我们发现是一个4-节点，于是我们将其分解：

![2-3-tree-delete-example-5](https://riteme.site/blogimg/rbtree-and-2-3-tree/23-tree-delete-example-5.png)
...
![rbtree-normal-node](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-normal-node.png)

如何表示3-节点呢？我们尝试一种特殊的边：默认情况下节点的颜色均为黑色。我们将某个节点染为红色，表示它和父亲的的链接是红色的，就像下图：

![rbtree-red-node-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-red-node-normal.png)

当我们将红链接画平时...

![rbtree-red-node-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-red-node-flat.png)
...
![rbtree-example-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-example-1.png)

如果将红链接画平，将得到一棵完美平衡的“2-3树”：

![rbtree-example-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-example-2.png)
...
![rbtree-rotate-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-rotate-1-2.png)
...
![rbtree-flip-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-flip-1.png)

对照一下2-3树，这个操作就显而易见了。

![rbtree-flip-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-flip-2-2.png)
...
![rbtree-insert-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-insert-1.png)
...
![rbtree-insert-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-insert-2.png)
...
![rbtree-insert-3](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-insert-3.png)
...
![rbtree-delete-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-delete-1.png)

上面就是利用了**反色操作**。
另一种情况是右儿子是一个3-节点，那么操作就有点复杂了：

![rbtree-delete-2](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-delete-2.png)
...
![rbtree-root-1](https://riteme.site/blogimg/rbtree-and-2-3-tree/rbtree-root-1-2.png)
