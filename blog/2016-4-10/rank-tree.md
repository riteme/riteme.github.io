...
![tree-example](https://riteme.site/blogimg/rank-tree/binary-tree.png)
...
![balance-situation-1](https://riteme.site/blogimg/rank-tree/rank-tree-balance-1.png)

现在我们要平衡`b`节点。左子树的秩比右子树大。倘若按照上面的方法进行调整，将会得到下面的结果：

![balance-situation-2](https://riteme.site/blogimg/rank-tree/rank-tree-balance-2.png)
...
![balance-situation-3](https://riteme.site/blogimg/rank-tree/rank-tree-balance-3.png)

然后再进行**左旋**操作，完成平衡：

![balance-situation-4](https://riteme.site/blogimg/rank-tree/rank-tree-balance-4.png)
